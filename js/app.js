(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".course__slider")) new core(".course__slider", {
            ...
            if (document.querySelector(".report__slider")) new core(".report__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                slidesPerView: 2,
                spaceBetween: 30,
                autoHeight: true,
            ...
            if (document.querySelector(".interier__slider")) new core(".interier__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                slidesPerView: 2,
                spaceBetween: 30,
                speed: 800,
        ...
        const dropdown = () => {
            document.addEventListener("click", (e => {
                ...
                if (!isDropdownButton && null != e.target.closest("[data-dropdown]")) return;
                let currentDropdown;
                if (isDropdownButton) {
